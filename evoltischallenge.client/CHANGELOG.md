...
- Create Angular project with ng: `ng new evoltischallenge.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`evoltischallenge.client.esproj`).
